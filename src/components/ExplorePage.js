...
const ExplorePage = ({ location: { pathname } }) => {
  ...
  const details = {
    ...
    ejigbo: {
      ...
      The indigenes of Ikorodu and Epe Divisions are mainly the Ijebus with pockets of Eko-Awori settlers along the coastland and riverine areas. `,
      body:
        'Located at NEPA bus stop, opposite GUO transport, we convey passengers from here to Asaba, Onitsha and Owerri. We deliver goods for our numerous customers from here to other places in the country',
    },
    'water line': {
      phone1: '09036771162',
      phone2: '09036771163',
    ...
    'tunde idiagbon': {
      ...
      body:
        'Located at plot 9, Tunde Idiagbon way, at Jabi Park Abuja, we convey passengers to Yenogoa, Port Harcourt and Lagos state',
    },
    owerri: {
      phone1: '07036736670',
