...
const ExplorePage = ({ location: { pathname } }) => {
  ...
  const details = {
    jibowu: {
      ...
      body: 'Situated at the ever busy transit hub of Jibowu, Yaba, travellers can board vehicles from our terminal to Port Harcourt, Yenogoa, Owerri and Abuja. There is also a lodge to accommodate travellers and members of the public',
    },
    ejigbo: {
      phone0: '08039164323',
      phone1: '0901084782',
      ...
      There is also an admixture of other pioneer settlers collectively known as the Ekos.
      The indigenes of Ikorodu and Epe Divisions are mainly the Ijebus with pockets of Eko-Awori settlers along the coastland and riverine areas. `,
      body: 'Located at NEPA bus stop, opposite GUO transport, we convey passengers from here to Benin, Asaba, Onitsha, Owerri, Umuahia and Aba. You can also join us to Warri, Ughelli, Yenogoa and Port Harcourt. We deliver goods for our numerous customers from here to other places in the country',
    },
    'water line': {
      phone0: '08039164323',
      phone1: '0901084783',
    ...
    'oil mill': {
      ...
      state: 'Rivers State',
      intro: `Rivers State, also known simply as Rivers, is one of the 36 states of Nigeria. According to census data released in 2006, the state has a population of 5,198,716, making it the sixth-most populous state in the country. Its capital and largest city, Port Harcourt, is economically significant as the centre of Nigeria's oil industry. Rivers State is bounded on the South by the Atlantic Ocean, to the North by Imo and Abia, to the East by Akwa Ibom State, and to the West by Bayelsa and Delta states. It is home of many ethnic group,majorly :Ikwerre people, Ikwerre, a subgroup of the Igbo Ethnic Group, Ijaw Subgroups, Ogoni people and many other ethnic groups. The people from Rivers State are known as "Riverians". The inland part of the state consists of tropical rainforest; towards the coast, the typical Niger Delta environment features many mangrove swamps. `,
      body: 'We convey customers from here going to Benin, Ijebu Ode, Lagos and Abuja',
    },
    'tunde idiagbon': {
      phone0: '08039164323',
      phone1: '09036771167',
      ...
      body: 'Located at plot 9, Tunde Idiagbon way, at Jabi Park Abuja, we convey passengers to Yenogoa, Warri, Benin, Ughelli, Port Harcourt, Owerri, Umuahia and Lagos state',
    },
    owerri: {
      phone0: '08039164323',
      phone1: '09010984788',
      ...
      body: 'Our booking office is situated at Egbu road. We convey passengers to Lagos, Jibowu, Mile 2, Maza Maza and Ejigbo. We also run Abuja',
    },
    yenogoa: {
      phone0: '08039164323',
      phone1: '09010984786',
            ...
            <div className='detail'>
              ...
              <div className='detail__items'>
                {[0, 1, 2, 3].reverse().map((i) =>
                  details[place]['phone' + i] ? (
                    <div>{details[place]['phone' + i]}</div>
                  ) : null
                )}
              </div>
            </div>
